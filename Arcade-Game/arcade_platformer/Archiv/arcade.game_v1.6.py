...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        """
        #Load in our image four our Life Display
        heart_source = f"../assets/images/HUD/hudHeart_full.png"
        self.heart = arcade.Sprite(heart_source, LIFE_SCALING)
        self.heart.center_x = 85
        self.heart.center_y = 575
        self.scene.add_sprite("Heart", self.heart)
        """
    ...
    def on_key_press(self, key, modifiers):
        ...
        #    self.player_sprite.change_x = PLAYER_MOVEMENT_SPEED2
    ...
    def on_key_release(self, key, modifiers):
        ...
        if key == arcade.key.LEFT or key == arcade.key.A:
            ...
            if self.player_sprite.change_x == PLAYER_MOVEMENT_SPEED2:
                self.player_sprite.change_x = PLAYER_MOVEMENT_SPEED
            elif self.player_sprite.change_x == -PLAYER_MOVEMENT_SPEED2:
                self.player_sprite.change_x = -PLAYER_MOVEMENT_SPEED
