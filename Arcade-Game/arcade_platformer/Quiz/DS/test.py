...
questions = [["Wann wurde die Maschinenfabrik Reinhausen gegründet?", "1929", "1986", "1999"]]
...
class Quiz:
    ...
    def Frage(self):
        ...
        if len(self.Fragen) > 0 and self.nummer < self.Max:
            ...
            frage = Text(window, font=("Arial", 14), width=80, height=4)
            frage.insert(END,fragenText)
            frage.grid(column=0,row=0,padx=180,pady=(150,0))
 
            self.antw1 = Button(window, text=self.a1, font=("Arial",14),width=60, command = self.control1)
            self.antw2 = Button(window, text=self.a2, font=("Arial",14),width=60, command = self.control2)
            self.antw3 = Button(window, text=self.a3, font=("Arial",14),width=60, command = self.control3)
            self.antw4 = Button(window, text=self.a4, font=("Arial",14),width=60, command = self.control4)
            ...
            lb.grid(column=0,row=0,padx=220,pady=(220,15))
...
class Menu:
    def __init__(self):
        ...
        self.Quiz.grid(column=0,row=0,padx=300,pady=220)
